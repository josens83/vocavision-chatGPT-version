        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="btn bg-white text-brand-primary hover:bg-white/90 hover:shadow-lg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              aria-label="무료로 시작하기"
            >
              무료로 시작하기
            </a>
            <a
              href="/pricing"
              className="btn border-2 border-white/30 text-white hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              aria-label="요금제 보기"
            >
              요금제 보기
            </a>
